...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY SHADOW  ♥️☺️*",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "917635955833",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "*Shadow_Force_Official*",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Shadow Force Official ❣️*",
// add bot owner name    
